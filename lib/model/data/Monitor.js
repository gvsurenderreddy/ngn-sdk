 ...
 * native direct proxy and weakmap support, this class will reflect those changes.
 * @abstract
 * @private
...
var createProxy = function(modelObj){
	var prx = Proxy(modelObj,{
		...
		set: function(obj,prop,value){
			...
			} else if (value instanceof NGN.model.Model || value instanceof NGN.model.data.Association) {
